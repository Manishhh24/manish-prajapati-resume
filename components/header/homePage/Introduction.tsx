...
const Introduction = () => {
  return (
    <section className="px-7 pt-7 flex flex-col lg:flex-row">
      <div className="bg-slate-200 p-10 flex mx-auto sm:-skew-x-6 w-[90%]">
        <div className="flex flex-col md:flex-row justify-around sm:skew-x-6 w-full">
          <div className="md:pl-7 flex justify-center md:justify-start lg:w-1/3">
            ...
            <img
              ...
              className="max-w-[200px] min-w-[200px] min-h-[150px] md:h-[300px] rounded-xl"
            />{" "}
            {/* </div> */}
            {/* </div> */}
          </div>
          <div className="md:ml-10">
            ...
            <p className="flex mx-auto w-full md:w-[90%]">
              {" "}
            ...
            <h1 className="text-right text-[50px]">"</h1>
          </div>
